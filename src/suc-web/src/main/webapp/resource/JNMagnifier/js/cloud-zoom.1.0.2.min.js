...
(function ($) {
    ...
    function CloudZoom(g, i) {
        ...
        this.init = function () {
            $('.cloud-zoom-loading', g.parent()).remove();
            n = g.parent().append(format('<div class=\'mousetrap\' style=\'background-image:url(".");z-index:999;position:absolute;width:%0px;height:%1px;left:%2px;top:21px;\'></div>', j.outerWidth(), j.outerHeight(), 0, 0)).find(':last');
...
$(this).find('span').insertBefore($(this));
}
opts = $.extend({
