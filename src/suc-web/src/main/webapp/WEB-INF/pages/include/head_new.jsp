...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/admin/css/yhxq.css"/>
...
<script src="<%=request.getContextPath()%>/resource/js/init_base.js"></script>
...
<script src="<%=request.getContextPath()%>/resource/js/artTemplate/template.js"></script>
<script src="<%=request.getContextPath()%>/resource/js/artTemplate/template-debug.js"></script>

<link rel="stylesheet" href="/resource/js/jDialog/jDialog.css" type="text/css">
<script type="text/javascript" src="/resource/js/jDialog.js"></script>
<script type="text/javascript" src="/resource/js/jDialog/jquery.drag.js"></script>
<script type="text/javascript" src="/resource/js/jDialog/jquery.mask.js"></script>
<script type="text/javascript" src="/resource/js/jDialog/jquery.dialog.js"></script>
...
<div class="top" id="top">
  <div class="wrap">
    ...
    <div class="login mr10">
    	欢迎您，
    	<a title="查看个人信息" href="userInfo.html" id="userInfo"></a> ！ [ <a title="我的工作台" href="/user/index.jspx">我的工作台</a> | <a title="进入后台管理" href="/admin/welcome.jspx" id="haveAdmin" style="display:">后台管理 | </a><a title="退出系统" href="<%=request.getContextPath() %>/admin/logout.do">退出</a> ]
