...
import com.idhoo.dhutil.util.ResourceUtil;
/**
 * 投诉系统设置
 * @author wangxichun
 *
 */
public class SucCommConfig {
	
	private static Logger logger = Logger.getLogger(SucCommConfig.class);

	/** 默认的配置文件 */
	private static String CONFIG_FILE = "classpath:config/suc-config.xml";
	...
	public static void main(String[] args) {
		try {
			SucCommConfig.init();
			System.out.println(SucCommConfig.get("domain"));
		} catch (Exception e) {
			e.printStackTrace();
		}
